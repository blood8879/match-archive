          ...
          <form className="flex flex-col gap-5 px-6 py-6" onSubmit={handleSubmit}>
            <label className="flex flex-col gap-2">
              ...
              <div className="relative">
                <input
                  ...
                  required
                />
                <User className="absolute right-4 top-1/2 -translate-y-1/2 text-[var(--text-muted)] pointer-events-none w-5 h-5" />
              </div>
            </label>
            ...
            <label className="flex flex-col gap-2">
              ...
              <div className="flex justify-end pt-1">
                <Link href="#" className="text-sm font-medium text-[var(--primary)] hover:text-[var(--primary)]/80 transition-colors">
                  비밀번호 찾기
                </Link>
              </div>
            </label>
