      ...
      <main className="flex-1 flex items-center justify-center p-3 sm:p-4 relative">
        ...
        <div className="flex flex-col max-w-[480px] w-full bg-[var(--background-dark)]/80 backdrop-blur-sm border border-[var(--border-dark)] rounded-xl shadow-lg relative z-10 overflow-hidden animate-fade-in">
          <div className="pt-6 sm:pt-8 px-4 sm:px-6 text-center">
            <h1 className="text-white tracking-tight text-2xl sm:text-[32px] font-bold leading-tight pb-1.5 sm:pb-2">환영합니다</h1>
          ...
          <form className="flex flex-col gap-4 sm:gap-5 px-4 sm:px-6 py-4 sm:py-6" onSubmit={handleSubmit}>
            <label className="flex flex-col gap-1.5 sm:gap-2">
              <span className="text-white text-sm sm:text-base font-medium leading-normal">이메일 또는 사용자 이름</span>
              <div className="relative">
                <input
                  ...
                  required
                />
                <User className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 text-[var(--text-muted)] pointer-events-none w-4 h-4 sm:w-5 sm:h-5" />
              </div>
            </label>
            ...
            <label className="flex flex-col gap-1.5 sm:gap-2">
              ...
              <div className="flex justify-end pt-0.5 sm:pt-1">
                <Link href="#" className="text-xs sm:text-sm font-medium text-[var(--primary)] hover:text-[var(--primary)]/80 transition-colors">
                  비밀번호 찾기
                </Link>
              </div>
            </label>
          ...
          <div className="pb-4 sm:pb-6 text-center">
            <p className="text-[var(--text-muted)] text-xs sm:text-sm">
              아직 팀 계정이 없으신가요?{" "}
              <Link href="/signup" className="text-[var(--primary)] hover:underline font-bold">
                회원가입
              </Link>
            </p>
          </div>
