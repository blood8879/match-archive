        ...
        <div className="flex flex-col max-w-[480px] w-full bg-[#0f2319]/80 backdrop-blur-sm border border-[#2e6b4e] rounded-xl shadow-2xl relative z-10 overflow-hidden">
            ...
            <label className="flex flex-col gap-2">
              ...
              <div className="relative">
                <input
                  ...
                  required
                />
                <Mail className="absolute right-4 top-1/2 -translate-y-1/2 text-[#8dceae] pointer-events-none w-5 h-5" />
              </div>
            </label>
          ...
          <div className="pb-6 text-center">
            <p className="text-[#8dceae] text-sm">
              이미 계정이 있으신가요?{" "}
              <Link href="/login" className="text-[#00e677] hover:underline font-bold">
                로그인
              </Link>
            </p>
          </div>
