...
export function PlayerStatsTabs({
  ...
  const [activeTab, setActiveTab] = useState<"season" | "career">("season");
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="text-text-secondary text-xs uppercase tracking-wider border-b border-[#2d5842]">
                    ...
                    <th className="pb-3 pr-2 font-medium text-center">도움</th>
                  </tr>
                </thead>
                <tbody className="text-sm">
                  ...
                  <tr className="bg-[#10231a] font-bold">
                    ...
                    <td className="py-4 pr-2 text-center text-[#8eccae]">
