        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="text-[#00e677] text-sm font-bold tracking-wider uppercase">
                Match History
              </span>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 h-11 px-4 bg-[#214a36] hover:bg-[#2b5d45] text-white font-medium rounded-xl transition-all border border-[#2f6a4d]"
              >
                <Filter className="w-4 h-4 text-[#8eccae]" />
                <span className="max-w-[120px] truncate">
                  {selectedTeamId === "ALL" ? "전체 팀" : selectedTeam?.name}
                </span>
                <ChevronDown
                  className={`w-4 h-4 text-[#8eccae] transition-transform ${
        ...
        {scheduledMatches.length > 0 && (
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm text-[#00e677] font-medium">
        ...
        {finishedMatches.length > 0 && (
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm text-[#8eccae] font-medium">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3 md:gap-4">
              <div className="flex items-center gap-2">
                <div className="size-10 md:size-12 rounded-full bg-[#1a4031] flex items-center justify-center border border-[#2f6a4d] overflow-hidden">
